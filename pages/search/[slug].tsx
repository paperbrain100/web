...
const SearchResults = () => {
  ...
  return (
    <Layout className='overflow-hidden'>
      ...
      <div className='flex bg-gray-50 max-h-screen'>
        <Toaster />
        ...
        <div className='w-full h-[89vh] flex flex-col overflow-y-scroll items-center'>
          {modal ? (
            <motion.div
              ...
              className='flex h-[90vh] flex-col  overflow-y-scroll border-gray-200 border-dotted rounded-md items-center m-4 bg-white'
            >
              <div className='flex rounded-md h-full flex-col items-center p-8 '>
                ...
                <div className='w-1/2 flex justify-center items-center mt-4'>
                  <button
                    ...
                    className='items-center flex gap-x-2 p-2 text-white text-sm text-center rounded-lg hover:bg-green-700 cursor-pointer bg-green-600 mt-4 m-2 px-4 hover:scale-105 transition-all w-32'
                  >
                    <AiFillFilePdf />
                    View PDF
                  </button>
                  <button className='items-center flex gap-x-2 p-2 text-green-700 border-green-700 border text-sm text-center rounded-lg hover:bg-gray-50 cursor-pointer mt-4 m-2 px-4 hover:scale-105 transition-all w-32'>
                    <AiOutlineStar />
                    Star
                  </button>
                </div>
