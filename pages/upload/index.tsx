    ...
    return (
        <Layout>
            ...
            <motion.div className='bg h-screen'>
                ...
                <div className='flex'>
                    <Sidebar papers={false} heading="Your Uploaded Papers" response={[{
                        "paper_authors"
                            :
                            "Elad Hazan",
                        "paper_summary"
                    ...
                    <div className='flex bg-white w-[90%] h-[85vh] border-2 border-green-200 flex-col items-center m-4 justify-center'>
                        <div className='flex flex-col items-center justify-center p-8'>
                            <RoughNotation animationDelay={1000} animationDuration={2000} type="highlight" color='#f0fdf4' show={true}>
                                <h1 className='flex items-center font-bold text-3xl p-2 m-2'>Your Uploaded Papers are here <BsArrowReturnLeft size={21} className="ml-4" /></h1>
                            </RoughNotation>
                        ...
                        <div className='flex flex-col items-center justify-center p-8'>
                            <RoughNotation animationDelay={1000} animationDuration={2000} type="highlight" color='#f0fdf4' show={true}>
                                <h1 className='flex items-center font-bold text-3xl p-2 m-2'>Upload Papers below</h1>
                            </RoughNotation>

                            <form className='flex flex-col items-center justify-center w-[90%]'>
                                <input type="file" name="file" id="file" className='w-[90%] p-2 m-2 border-2 border-green-200 rounded-md' />
                            </form>
                        </div>
                    </div>
                </div>
