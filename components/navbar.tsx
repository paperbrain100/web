...
import { AiOutlineLogout, AiOutlineStar, AiOutlineSearch, AiOutlineUpload } from 'react-icons/ai';
...
const Navbar = ({ heading }: { heading: Boolean }) => {
    ...
    return (
        <motion.div
            ...
            {
                heading && <h1 className='opacity-50 text-3xl text-green-900'>PaperBrain</h1>
            }
